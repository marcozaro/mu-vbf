...
C     
      CALL MUMMUP_WPWMMUPMUM_SMATRIX_SPLITORDERS(P,MATELEMS)
      MATELEM=MATELEMS(0)
      WRITE(*,*) '1) Matrix element for (QCD=6 QED=2) = ',MATELEMS(1)
      WRITE(*,*) '2) Matrix element for (QCD=5 QED=3) = ',MATELEMS(2)
      WRITE(*,*) '3) Matrix element for (QCD=4 QED=4) = ',MATELEMS(3)
      WRITE(*,*) '4) Matrix element for (QCD=3 QED=5) = ',MATELEMS(4)
      WRITE(*,*) '5) Matrix element for (QCD=2 QED=6) = ',MATELEMS(5)
      WRITE(*,*) '6) Matrix element for (QCD=1 QED=7) = ',MATELEMS(6)
      WRITE(*,*) '7) Matrix element for (QCD=0 QED=8) = ',MATELEMS(7)
C     
