...
C     gl  
      DOUBLE PRECISION FUNCTION GET_CCBLO_1(LEG_A,LEG_B)
      IMPLICIT NONE
...
C     QAMPSO)      
     ...
     $   ))THEN
          GET_CCBLO_1 = COLOR_CORRELATED_EVALS(I,1)
          EXIT
        ENDIF
      ENDDO
      RETURN
...
C     --------------------------------------------------------------
      ...
      DOUBLE PRECISION FUNCTION GET_KKBLO_1(PARENT_LEG,PB,KT)
      IMPLICIT NONE
      INTEGER I
      INTEGER NEXTERNAL
      PARAMETER (NEXTERNAL=4)
      ...
      CALL SET_SPIN_CORRELATION_VECTORS_1(PARENT_LEG,NVECTOR_TO_TRY_PER_L
     $EG,SCVECTORS)
      CALL SMATRIX_SPLITORDERS_1(PB,MATELEMS)
      GET_KKBLO_1 = MATELEMS(0)
