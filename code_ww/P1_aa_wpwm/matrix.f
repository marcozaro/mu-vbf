...
C     =========================================================
      ...
      SUBROUTINE GET_N_COLOR_CONNECTIONS_NNLO(N_CC)
      IMPLICIT NONE
      INTEGER N_CC_FOR_THAT_ORDER
      PARAMETER (N_CC_FOR_THAT_ORDER=0)
      INTEGER N_CC
CF2PY INTENT(OUT) :: N_CC
      N_CC = N_CC_FOR_THAT_ORDER
      END SUBROUTINE GET_N_COLOR_CONNECTIONS_NNLO

      SUBROUTINE APPLY_COLOR_CONNECTION_DEFINITIONS_NNLO()
C     This routine initialise the mapping of the color connections for
C      order NNLO
...
C      be zero
     ...
     $  COLOR_CONNECTION_INITIALIZED
      ...
      END SUBROUTINE APPLY_COLOR_CONNECTION_DEFINITIONS_NNLO

      SUBROUTINE COLOR_CONNECTION_TO_INDEX_NNLO(SPECIFIER_A
...
C     ----------
      ...
      IF (.NOT.COLOR_CONNECTION_INITIALIZED) THEN
        COLOR_CONNECTION_INITIALIZED = .TRUE.
        CALL APPLY_COLOR_CONNECTION_DEFINITIONS_NNLO()
      ENDIF
...
C     And return it now
     ...
     $ ,CC_SPECIFIER(3),CC_SPECIFIER(4))
      ...
      END SUBROUTINE COLOR_CONNECTION_TO_INDEX_NNLO

      SUBROUTINE INDEX_TO_COLOR_CONNECTION_NNLO(INDEX_IN,SPECIFIER_A
     $ ,SPECIFIER_B)
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Return the color connection for this index
     ...
     $ -INDEX_NNLO_OFFSET,2,3)
      ...
      END SUBROUTINE INDEX_TO_COLOR_CONNECTION_NNLO

      FUNCTION GET_COLOR_CONNECTION_INDEX_NNLO(SPECIFIER_A,SPECIFIER_B)
      IMPLICIT NONE
C     
C     ARGUMENTS 
C     
      ...
      INTEGER GET_COLOR_CONNECTION_INDEX_NNLO
C     
C     LOCAL VARIABLES
C     
      INTEGER CC_INDEX
...
C     ----------
      ...
      CALL COLOR_CONNECTION_TO_INDEX_NNLO(SPECIFIER_A,SPECIFIER_B,
     $  CC_INDEX)
      GET_COLOR_CONNECTION_INDEX_NNLO = CC_INDEX

      END FUNCTION GET_COLOR_CONNECTION_INDEX_NNLO
