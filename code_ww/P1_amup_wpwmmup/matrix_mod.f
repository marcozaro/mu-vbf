...
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,10),W(1,2),W(1,6),GC_67,AMP(4))
      CALL FFV1P0_3(W(1,5),W(1,2),GC_3,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL VVV1_0(W(1,11),W(1,4),W(1,6),GC_4,AMP(5))
      CALL FFV2_4P0_3(W(1,5),W(1,2),GC_68,GC_77,MDL_MZ,MDL_WZ,W(1,12))
...
C     gl  
      DOUBLE PRECISION FUNCTION GET_CCBLO_2(LEG_A,LEG_B)
      IMPLICIT NONE
...
C     QAMPSO)      
     ...
     $   ))THEN
          GET_CCBLO_2 = COLOR_CORRELATED_EVALS(I,1)
          EXIT
        ENDIF
      ENDDO
      RETURN
...
C     --------------------------------------------------------------
      ...
      DOUBLE PRECISION FUNCTION GET_KKBLO_2(PARENT_LEG,PB,KT)
      IMPLICIT NONE
      INTEGER I
      INTEGER NEXTERNAL
      PARAMETER (NEXTERNAL=5)
      ...
      CALL SET_SPIN_CORRELATION_VECTORS_2(PARENT_LEG,NVECTOR_TO_TRY_PER_L
     $EG,SCVECTORS)
      CALL SMATRIX_SPLITORDERS_2(PB,MATELEMS)
      GET_KKBLO_2 = MATELEMS(0)
