...
C     gl  
      DOUBLE PRECISION FUNCTION GET_CCBLO_3(LEG_A,LEG_B)
      IMPLICIT NONE
...
C     QAMPSO)      
     ...
     $   ))THEN
          GET_CCBLO_3 = COLOR_CORRELATED_EVALS(I,1)
          EXIT
        ENDIF
      ENDDO
      RETURN
...
C     --------------------------------------------------------------
      ...
      DOUBLE PRECISION FUNCTION GET_KKBLO_3(PARENT_LEG,PB,KT)
      IMPLICIT NONE
      INTEGER I
      INTEGER NEXTERNAL
      PARAMETER (NEXTERNAL=5)
      ...
      CALL SET_SPIN_CORRELATION_VECTORS_3(PARENT_LEG,NVECTOR_TO_TRY_PER_L
     $EG,SCVECTORS)
      CALL SMATRIX_SPLITORDERS_3(PB,MATELEMS)
      GET_KKBLO_3 = MATELEMS(0)
