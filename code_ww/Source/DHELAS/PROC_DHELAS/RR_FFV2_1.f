...
C     
      SUBROUTINE RR_FFV2_1(F2, V3, COUP, M1, W1,F1)
      IMPLICIT NONE
      COMPLEX*16 CI
...
C     Gamma(3,2,-1)*ProjM(-1,1)
C     
      SUBROUTINE RR_FFV2_5_1(F2, V3, COUP1, COUP2, M1, W1,F1)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 F2(*)
      ...
      INTEGER*4 I
      COMPLEX*16 FTMP(6)
      CALL RR_FFV2_1(F2,V3,COUP1,M1,W1,F1)
      CALL RR_FFV5_1(F2,V3,COUP2,M1,W1,FTMP)
      DO I = 3, 6
        F1(I) = F1(I) + FTMP(I)
      ENDDO
      END
...
C     Gamma(3,2,-1)*ProjM(-1,1)
C     
      SUBROUTINE RR_FFV2_3_1(F2, V3, COUP1, COUP2, M1, W1,F1)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 F2(*)
      ...
      COMPLEX*16 FTMP(6)
      CALL RR_FFV2_1(F2,V3,COUP1,M1,W1,F1)
      CALL RR_FFV3_1(F2,V3,COUP2,M1,W1,FTMP)
      DO I = 3, 6
        F1(I) = F1(I) + FTMP(I)
      ENDDO
      END
...
C     Gamma(3,2,-1)*ProjM(-1,1)
C     
      SUBROUTINE RR_FFV2_4_1(F2, V3, COUP1, COUP2, M1, W1,F1)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 F2(*)
      ...
      COMPLEX*16 FTMP(6)
      CALL RR_FFV2_1(F2,V3,COUP1,M1,W1,F1)
      CALL RR_FFV4_1(F2,V3,COUP2,M1,W1,FTMP)
      DO I = 3, 6
        F1(I) = F1(I) + FTMP(I)
      ENDDO
      END
