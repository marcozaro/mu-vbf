      SUBROUTINE ME_ACCESSOR_HOOK_3(P,HEL,USER_ALPHAS,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     ----------
      ...
      CALL SMATRIXHEL_SPLITORDERS_3(P,HEL,ANS)

      END

      SUBROUTINE SMATRIX_3(P,ANS_SUMMED)
C     
...
C     BEGIN CODE
C     
      CALL SMATRIX_SPLITORDERS_3(P,ANS)
      ANS_SUMMED=ANS(0)

      END

      SUBROUTINE SMATRIXHEL_3(P,HEL,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     
      INTEGER USERHEL
      COMMON/HELUSERCHOICE_3/USERHEL
C     ----------
C     BEGIN CODE
C     ----------
      USERHEL=HEL
      CALL SMATRIX_3(P,ANS)
      USERHEL=-1

      END

C     Give access to the helicity definition to the f2py API.
      SUBROUTINE GET_HELICITY_DEFINITIONS_3(NHEL_OUT)
      IMPLICIT NONE
      ...
      COMMON/BORN_HEL_CONFIGS_3/NHEL
...
CF2PY INTENT(OUT) :: NHEL_OUT
      ...
      SUBROUTINE SMATRIX_SPLITORDERS_3(P,ANS)
C     
...
C     
      ...
      COMMON/CHOSEN_BORN_SQSO_3/CHOSEN_SO_CONFIGS
C     
C     ARGUMENTS 
C     
      REAL*8 P(0:3,NEXTERNAL),ANS(0:NSQAMPSO)
...
C     
      ...
      COMMON/BORN_BEAM_POL_3/POLARIZATIONS
...
C      indices are which one to consider
     ...
     $ ,NSQAMPSO) / NCC_TIMES_NSQAMPSO*0.0D0 /
      COMMON/COLOR_CORRELATIONS_3/COLOR_CORRELATORS_TO_CONSIDER,
...
C     FUNCTIONS
C     
      LOGICAL IS_BORN_HEL_SELECTED_3
...
C      use to insert the extra spin. corr. runs.
     ...
     $       (.NOT.IS_BORN_HEL_SELECTED_3(IHEL))) THEN
              CYCLE
            ENDIF
...
C            a normal run if not spin-correlations are active
     ...
     $         -1.OR.IS_BORN_HEL_SELECTED_3(IHEL))
              DO I=1,NEXTERNAL
...
C                 Spin correlation, enforce the polarization vector
     ...
     $               , I),J)
                ...
                ENDIF
              ENDDO
              CALL MATRIX_3(P ,HELICITIES(1),JC(1), T,
...
C              spin-correlation runs
     ...
     $           (CCI,I)/POLARIZATIONS(J,0)
      ...
      SUBROUTINE SMATRIXHEL_SPLITORDERS_3(P,HEL,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     ----------
      ...
      SUBROUTINE MATRIX_3(P,NHEL,IC,RES, DO_INCLUDE_HEL_CONTRIB,WEXT)
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1P0_3(W(1,2),W(1,5),GC_3,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,4),W(1,6),W(1,9),GC_2,AMP(3))
      CALL FFV2_4P0_3(W(1,2),W(1,5),GC_68,GC_77,MDL_MZ,MDL_WZ,W(1,10))
...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,2),W(1,6),W(1,7),GC_3,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_4_0(W(1,2),W(1,6),W(1,8),GC_68,GC_77,AMP(8))
...
C     JAMPs contributing to orders QCD=0 QED=3
     ...
     $             *DCONJG(JAMP(I,N))/CC_DENOM(CCI,I)
      ...
      SUBROUTINE GET_ME_3(P, ALPHAS, NHEL ,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C      automatically found
      ...
      LOGICAL FUNCTION IS_BORN_HEL_SELECTED_3(HELID)
      IMPLICIT NONE
C     
C     CONSTANTS
C     
...
C     
      ...
      COMMON/BORN_HEL_CONFIGS_3/HELC
...
C     --------------------------------------------------------------
      ...
      SUBROUTINE GET_COLOR_CORRELATED_ME_3(CORRELATED_MES)
      IMPLICIT NONE
...
C      indices are which one to consider
     ...
     $  COLOR_CORRELATED_EVALS
      ...
      SUBROUTINE GET_COLOR_CORRELATOR_ID_3(CONNECTION_INDEX_A,
...
CF2PY INTENT(OUT) :: ID
     ...
     $  2)
      COMMON/COLOR_CORRELATION_MAPS_3/COLOR_CORRELATOR_TO_INDEX,
     ...
     $  CONNECTION_INDEX_B)
      ...
      SUBROUTINE GET_COLOR_CORRELATOR_FOR_ID_3(IDX, CONNECTION_INDEX_A,
     $  CONNECTION_INDEX_B)
      IMPLICIT NONE
...
CF2PY INTENT(OUT) :: CONNECTION_INDEX_B
     ...
     $  CORRELATOR_INDEX_TO_CONNECTION_INDEX
      ...
      SUBROUTINE GET_N_COLOR_CORRELATORS_3(N_COLOR_CORRELATORS)
...
CF2PY INTENT(OUT) :: N_COLOR_CORRELATORS
      ...
      SUBROUTINE ADD_COLOR_CORRELATORS_TO_CONSIDER_3(FIRST_CONNECTION,
     $  SECOND_CONNECTION)
      IMPLICIT NONE
...
C     ----------
     ...
     $  SECOND_CONNECTION)
      ...
      SUBROUTINE SET_COLOR_CORRELATORS_TO_CONSIDER_3(FIRST_CONNECTION,
     $  SECOND_CONNECTION)
      IMPLICIT NONE
...
C     --------------------------------------------------------------
      ...
      SUBROUTINE SET_SPIN_CORRELATION_VECTORS_3(LEG_INDEX, N_VECTORS,
     $  VECTORS)
      IMPLICIT NONE
...
C      to SPIN_CORR_RUNS
      ...
      SUBROUTINE RESET_SPIN_CORRELATION_VECTORS_3()
      IMPLICIT NONE
...
C     ----------
      ...
      SUBROUTINE GET_MAX_N_SPIN_CORR_VECTORS_3(MAX_N_SC_VECTORS)
      IMPLICIT NONE
      INTEGER    NEXTERNAL
      PARAMETER (NEXTERNAL=5)
      INCLUDE 'spin_correlations.inc'
...
CF2PY INTENT(OUT) :: MAX_N_SC_VECTORS
      ...
      SUBROUTINE GET_MAX_N_SPIN_CORR_LEGS_3(MAX_N_SC_LEGS)
      IMPLICIT NONE
      INTEGER    NEXTERNAL
      PARAMETER (NEXTERNAL=5)
      INCLUDE 'spin_correlations.inc'
...
CF2PY INTENT(OUT) :: MAX_N_SC_LEGS
      ...
      SUBROUTINE GET_COLOR_CONNECTION_MAX_ORDER_3(MAX_ORDER)
      IMPLICIT NONE
...
C     =========================================================
      ...
      SUBROUTINE GET_N_COLOR_CONNECTIONS_NLO_3(N_CC)
      IMPLICIT NONE
...
CF2PY INTENT(OUT) :: N_CC
      ...
      SUBROUTINE APPLY_COLOR_CONNECTION_DEFINITIONS_NLO_3()
...
C      be zero
      ...
      COMMON/COLOR_CONNECTION_DEFINITIONS_NLO_3/COLOR_CONNECTIONS,
...
C     NLO color connection ((4, -1, 4),) --> 1 T(301,4,104)
      ...
      SUBROUTINE COLOR_CONNECTION_TO_INDEX_NLO_3(SPECIFIER_A, INDEX_OUT)
      IMPLICIT NONE
C     
C     CONSTANTS
C     
...
C     ----------
      ...
      IF (.NOT.COLOR_CONNECTION_INITIALIZED) THEN
        ...
        CALL APPLY_COLOR_CONNECTION_DEFINITIONS_NLO_3()
      ENDIF
...
C     And return it now
      ...
      SUBROUTINE INDEX_TO_COLOR_CONNECTION_NLO_3(INDEX_IN,SPECIFIER_A)
      IMPLICIT NONE
C     
C     CONSTANTS
C     
...
C     NLO color connection ((4, -1, 4),) --> 1 T(301,4,104)
      ...
      COMMON/CC_INDEX_TO_DEFINITION_NLO_3/CC_INDEX_TO_DEFINITION_NLO
...
C     Return the color connection for this index
     ...
     $ -INDEX_NLO_OFFSET,1,3)
      ...
      FUNCTION GET_COLOR_CONNECTION_INDEX_NLO_3(SPECIFIER_A)
      IMPLICIT NONE
C     
C     ARGUMENTS 
C     
      ...
      INTEGER GET_COLOR_CONNECTION_INDEX_NLO_3
C     
C     LOCAL VARIABLES
C     
      INTEGER CC_INDEX
...
C     ----------
      ...
      CALL COLOR_CONNECTION_TO_INDEX_NLO_3(SPECIFIER_A, CC_INDEX)
      GET_COLOR_CONNECTION_INDEX_NLO_3 = CC_INDEX

      END FUNCTION GET_COLOR_CONNECTION_INDEX_NLO_3
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX_3(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS_3/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS_3
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   (ORDERINDEXB,I)
      ENDDO
      SQSOINDEX_3=SOINDEX_FOR_SQUARED_ORDERS_3(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS_3(ORDERS)
C     
...
C     
      ...
      COMMON/ALL_SQSPLITORDERS_3/SQSPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS_3 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS_3'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN_3(NSQSO)
C     
...
C     This is the inverse subroutine of SOINDEX_FOR_SQUARED_ORDERS_3.
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX_3(SOINDEX,ORDERS)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX_3(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS_3(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS_3 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS_3'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
...
C     --------
      ...
      SUBROUTINE GET_SPLIT_ORDER_NAMES_3(SONAMES)
      IMPLICIT NONE
C     
C     CONSTANTS
C     
