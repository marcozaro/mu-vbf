...
c !!!!! original code  Improved Weizsaecker-Williams !!!!!
c         if(q2min.lt.q2max) then 
c             f = alpha/2d0/PI*
c     &           (2d0*xin(imode)*xin(imode)*x*(-1/q2min+1/q2max)+
...
c     &           +0d0 )
c !!!!! PDF: (4.189) of 1909.03886 with K_gammae such that -2logz -1 disappears (Delta, i.e., (3.5) of 2105.06688)    !!!!!
